            ...
            <div class="modal-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left">
                                    <b>
                                        {!! $user->userProfile ? ('<span class="text-success"><i class="fa-solid fa-circle"></i></span>'):'&nbsp;' !!}&nbsp;
                                        {{ $user->name }}
                                    </b>
                                </td>
                                <td class="text-right">
                                    @can('userProfiles.edit')
                                        <a href="{{ route('admin.userProfiles.setUser',[$userProfile,$user]) }}" class="btn btn-sm btn-green"><i class="fe fe-plus-circle fw-bold"></i></a>
                                    @endcan
                                </td>
                            </tr>
                            @endforeach
                ...
                @else
                    <div class="col-12 text-center">
                        <span>{{ trans('messages.UserProfile.NoUserProfiles') }}</span>
                        @can('users.create')
