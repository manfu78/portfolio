...
@section('sectiontitle') {{ trans('messages.Business.EditBusiness') }} @endsection
    ...
    <div class="main-container container-fluid">
        ...
        <div class="row ">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                @include('Admin.Businesses.Partials.form_documents')
            </div>
        </div>
...
@section('scripts')
    <script>
        $(function(e) {
            ...
            // $('.documentSelect2-show-search').select2({
            //     minimumResultsForSearch: '',
            //     width: '100%'
            // });

            // documentSelect2-search__field
            // $('.documentSelect2').on('click', () => {
            //     let selectField = document.querySelectorAll('.documentSelect2-search__field')
