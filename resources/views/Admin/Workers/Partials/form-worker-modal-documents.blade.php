    ...
    <div class="col-12">
        <div class="form-group">
            ...
            <input type="textarea" name="description"
                ...
                value="{{ isset($worker)?$worker->description:old('description') }}"
                maxlength="500"
                rows="3">
        </div>
    </div>
...
<div class="row">
    <div class="col-12 col-sm-4">
        ...
        <div class="form-group">
            <select name="document_type_id" class="form-control select2 {{ (($errors)->has('document_type_id')?'is-invalid':'') }}" data-bs-placeholder="{{ "Select ".trans('messages.DocumentType.DocumentType') }}" style="width: 100%;" required>
