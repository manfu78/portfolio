...
@section('sectiontitle') {{ trans('messages.Supplier.EditSupplier') }} @endsection
        ...
        <div class="page-header">
            ...
            <div>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ trans('messages.Supplier.EditSupplier') }}</li>
                </ol>
            </div>
        </div>
        @include('Admin.Suppliers.Partials.menu')
        <div class="row ">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <form action="{{ route('admin.suppliers.update',$supplier->id) }}" method="post" name="form_supplier" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                ...
                {{-- MODAL Contactos --}}
                <form action="{{ route('admin.suppliers.addContact',$supplier->id) }}" method="post" name="form_modal_contact">
                    @csrf
                    @method('PUT')
                    <div class="modal fade" id="modalSelectSupplierContact">
