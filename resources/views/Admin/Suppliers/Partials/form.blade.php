<div class="card">
    <div class="card-header bg-info-transparent p-2">
        @if (isset($supplier))
            <span class="fw-bold"><i class="fa-solid fa-pen-to-square"></i></span>&nbsp;{{ trans('messages.Supplier.EditSupplier') }}
        @else
            <span class="fw-bold"><i class="fe fe-file-plus"></i></span>&nbsp;{{ trans('messages.Supplier.CreateSupplier') }}
        @endif
    </div>
    <div class="card-body">
        <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="form-control-plaintext material-switch pull-right">
                        <input type="checkbox"
                            ...
                            value="1" @if (isset($supplier)) {{  $supplier->status? 'checked':'' }} @else checked @endif>
            ...
            <div class="col-12 col-sm-5 col-md-5 col-lg-4 col-xl-4 col-xxl-4">
                <div class="form-group">
                    ...
                    <input type="text" name="ncc"
                        ...
                        value="{{ isset($supplier)?$supplier->ncc:'' }}"
                        autocomplete="ncc"
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                <div class="form-group">
                    <small>
                        ...
                        @if (request()->routeIs('admin.supplier.create')) <span class="text-red">*</span> @endif
                    </small>
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                <div class="form-group">
                    ...
                    <input type="text" name="tradename"
                        ...
                        value="{{ isset($supplier)?$supplier->tradename:'' }}"
            ...
            <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
                <div class="form-group">
                    ...
                    <input type="text" name="cif"
                        ...
                        value="{{ isset($supplier)?$supplier->cif:'' }}"
                        autocomplete="cif"
                        max="9">
                </div>
            </div>
...
@if (isset($supplier))
    <div class="card">
        ...
        <div class="card-body">
            @if ($supplier->supplierContacts->count()>0)
                <div class="row mb-3">
                    <div class="col-12 table-responsive">
                        <table id="bank_account_table" class="table table-striped table-hover">
                            ...
                            <tbody>
                                @foreach ($supplier->supplierContacts as $contact)
                                <tr>
                                    ...
                                    <td class="py-1 text-end text-nowrap" style="width: 60px;">
                                        @can('suppliers.edit')
                                            <a class="modal-effect btn text-danger btn-sm py-0"
                                                ...
                                                data-route="{{ route('admin.suppliers.deleteContact',$contact->id) }}">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <a class="modal-effect btn btn-info-light"
                        ...
                        href="#modalSelectSupplierContact">
            ...
            <div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
                <div class="form-group">
                    ...
                    <input type="text"
                        ...
                        value="{{ isset($supplier)?$supplier->postal_code:old('postal_code') }}">
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="form-group">
                    ...
                    <select name="country_id" class="form-control select2-show-search form-select {{ (($errors)->has('country_id')?'is-invalid':'') }}" data-bs-placeholder="{{ "Select ".trans('messages.Country.Country') }}">
                        @foreach($countrySelect as $countryId => $countryName)
                            <option value="{{ $countryId }}" @if (isset($supplier) && $countryId == $supplier->country_id) selected @else {{ $countryId == 73?'selected':'' }} @endif>
                            {{ $countryName }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
                <div class="form-group">
                    ...
                    <input type="text"
                        ...
                        value="{{ isset($supplier)?$supplier->latitude:old('latitude') }}">
                </div>
            </div>
            <div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 col-xxl-3">
                <div class="form-group">
                    ...
                    <input type="text"
                        ...
                        value="{{ isset($supplier)?$supplier->longitude:old('longitude') }}">
                </div>
            </div>
        </div>
        <div class="row mt-3">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                <div class="form-group">
                    ...
                    <input type="text" name="bic"
                        ...
                        value="{{ isset($supplier)?$supplier->bic:'' }}"
                        autocomplete="bic"
                        onkeyup="this.value = this.value.toUpperCase();"
                        max="255">
                </div>
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                <div class="form-group">
                    ...
                    <input type="text" name="iban"
                        ...
                        value="{{ isset($supplier)?$supplier->iban:'' }}"
                        autocomplete="iban"
                        onkeyup="this.value = this.value.toUpperCase();"
                        max="24"
                        min="24">
                ...
                <div class="form-group">
                    ...
                    <select name="vat_id" class="form-control select2-show-search form-select {{ (($errors)->has('vat_id')?'is-invalid':'') }}" data-bs-placeholder="{{ "Select ".trans('messages.Vat.Vat') }}">
                        @foreach($vatSelect as $vatId => $vatName)
                            <option value="{{ $vatId }}" @if (isset($supplier) && $vatId == $supplier->vat_id) selected @else {{ $vatId == 73?'selected':'' }} @endif>
                            {{ $vatName }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="col-12 col-sm-3 col-md-3 col-lg-2 col-xl-2 col-xxl-2">
                <div class="form-group">
                    ...
                    <input type="number" name="comercial_discount"
                        ...
                        value="{{ isset($supplier)?$supplier->comercial_discount:old('comercial_discount') }}"
                        step="0.01">
                </div>
            </div>
            <div class="col-12 col-sm-3 col-md-3 col-lg-2 col-xl-2 col-xxl-2">
                <div class="form-group">
                    ...
                    <input type="number" name="pront_payment_discount"
                        ...
                        value="{{ isset($supplier)?$supplier->pront_payment_discount:old('pront_payment_discount') }}"
                        step="0.01">
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <textarea name="observations"
                        ...
                        rows="3">{{ isset($supplier)?$supplier->observations:old('observations') }}</textarea>
                </div>
            </div>
        </div>
    </div>
