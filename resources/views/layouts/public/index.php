    ...
    <div class="interests container">
        ...
        <div class="row">
            ...
            <div class="icon-box" style="margin-bottom: 5px;">
                ...
                <img src="assets/img/logos/laravel.png" alt="" style="height: 25px;">
                <h3>&nbsp; Laravel</h3>
            </div>
            </div>
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
            <div class="icon-box" style="margin-bottom: 5px;">
                <img src="assets/img/logos/php.png" alt="" style="height: 35px;">
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                <img src="assets/img/logos/mysql.png" alt="" style="height: 45px;">
                <!-- <i class="ri-bar-chart-box-line" style="color: #5578ff;"></i> -->
                <h3>&nbsp; MySQL</h3>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                <img src="assets/img/logos/postgres.png" alt="" style="height: 45px;">
                <!-- <i class="ri-bar-chart-box-line" style="color: #5578ff;"></i> -->
                <h3>&nbsp; PostgreSQL</h3>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                <img src="assets/img/logos/java.png" alt="" style="height: 25px;">
                <!-- <i class="ri-bar-chart-box-line" style="color: #5578ff;"></i> -->
                <h3>&nbsp; Java</h3>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                <img src="assets/img/logos/docker.png" alt="" style="height: 25px;">
                <!-- <i class="ri-bar-chart-box-line" style="color: #5578ff;"></i> -->
                <h3>&nbsp; Docker</h3>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                <img src="assets/img/logos/flutter.png" alt="" style="height: 25px;">
                <!-- <i class="ri-bar-chart-box-line" style="color: #5578ff;"></i> -->
                <h3>&nbsp; Flutter</h3>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                <img src="assets/img/logos/swift.png" alt="" style="height: 25px;">
                <!-- <i class="ri-bar-chart-box-line" style="color: #5578ff;"></i> -->
                <h3>&nbsp; Swift</h3>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                <img src="assets/img/logos/asp_w.png" alt="" style="height: 25px;">
                <!-- <i class="ri-bar-chart-box-line" style="color: #5578ff;"></i> -->
                <h3>&nbsp; ASP</h3>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                <img src="assets/img/logos/javascript.png" alt="" style="height: 25px;">
                <!-- <i class="ri-bar-chart-box-line" style="color: #5578ff;"></i> -->
                <h3>&nbsp; Javascript</h3>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                <img src="assets/img/logos/css.png" alt="" style="height: 25px;">
                <!-- <i class="ri-bar-chart-box-line" style="color: #5578ff;"></i> -->
                <h3>&nbsp; Css</h3>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                <img src="assets/img/logos/bootstrap.png" alt="" style="height: 25px;">
                <!-- <i class="ri-bar-chart-box-line" style="color: #5578ff;"></i> -->
                <h3>&nbsp; Bootsrap</h3>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                <img src="assets/img/logos/cosmos.png" alt="" style="height: 25px;">
                <!-- <i class="ri-bar-chart-box-line" style="color: #5578ff;"></i> -->
                <h3>&nbsp; Cosmos</h3>
                </div>
            </div>
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                <img src="assets/img/logos/photoshop.png" alt="" style="height: 25px;">
                <!-- <i class="ri-bar-chart-box-line" style="color: #5578ff;"></i> -->
                <h3>&nbsp; Photoshop</h3>
                </div>
            </div>
      ...
      <div class="testimonials-slider swiper" data-aos="fade-up" data-aos-delay="100">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                ...
                <img src="assets/img/customers/spm_t.png" class="testimonial-img" alt="">
                <h3>SPM</h3>
            ...
            <div class="swiper-slide">
                ...
                <img src="assets/img/customers/procuba_t.png" class="testimonial-img" alt="">
                <h3>Procuba</h3>
            ...
            <div class="swiper-slide">
                ...
                <img src="assets/img/customers/plantiagro_t.png" class="testimonial-img" alt="">
            ...
            <div class="swiper-slide">
                ...
                <img src="assets/img/customers/frimaq_t.png" class="testimonial-img" alt="">
                <h3>Frimaq</h3>
            ...
            <div class="swiper-slide">
                ...
                <img src="assets/img/customers/car_t.png" class="testimonial-img" alt="">
                <h3>CAR Murcia</h3>
            ...
            <div class="swiper-slide">
                ...
                <img src="assets/img/customers/campolor_t.png" class="testimonial-img" alt="">
                <h3>Campolor</h3>
            ...
            <div class="swiper-slide">
                ...
                <img src="assets/img/customers/almerimur_t.png" class="testimonial-img" alt="">
                <h3>Almerimur</h3>
            ...
            <div class="swiper-slide">
                ...
                <img src="assets/img/customers/cmolina_t.png" class="testimonial-img" alt="">
                <h3>Hnos. Molina</h3>
            ...
            <div class="swiper-slide">
                ...
                <img src="assets/img/customers/tofilm_t.png" class="testimonial-img" alt="">
                <h3>TOFILM</h3>
    ...
    <div class="interests container">
        <div class="row">
            <div class="col-lg-3 col-md-4">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <!-- <i class="ri-store-line" style="color: #ffbb2c;"></i> -->
                    <img src="assets/img/customers/electriloal_t.png" alt="" style="height: 45px;">
                    <h3>&nbsp; ELECTROLOAL</h3>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/enerfrical_t.png" alt="" style="height: 35px;">
                    <h3>&nbsp; ENERFRICAL</h3>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/gesproen_t.png" alt="" style="height: 35px;">
                    <h3>&nbsp; GESPROEN</h3>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/gonzalbez_t.png" alt="" style="height: 35px;">
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/inprosystem_t.png" alt="" style="height: 35px;">
                    <h3>&nbsp; INPROSYSTEM</h3>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/labascula_t.png" alt="" style="height: 35px;">
                    <h3>&nbsp; LA BASCULA</h3>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/monteazahar_t.png" alt="" style="height: 35px;">
                    <h3>&nbsp; MONTEAZAHAR</h3>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/solideo_t.png" alt="" style="height: 35px;">
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/tercilor_t.png" alt="" style="height: 35px;">
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/spm_t.png" alt="" style="height: 35px;">
                    <h3>&nbsp; AGENCIA SPM</h3>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/campolor_t.png" alt="" style="height: 35px;">
                    <h3>&nbsp; CAMPOLOR</h3>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/almerimur_t.png" alt="" style="height: 35px;">
                    <h3>&nbsp; ALMERIMUR</h3>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/procuba_t.png" alt="" style="height: 35px;">
                    <h3>&nbsp; PROCUBA</h3>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/plantiagro_t.png" alt="" style="height: 35px;">
                    <h3>&nbsp; PLANTIAGRO</h3>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/cmolina_t.png" alt="" style="height: 35px;">
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/frimaq_t.png" alt="" style="height: 35px;">
                    <h3>&nbsp; FRIMAQ</h3>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/tofilm_t.png" alt="" style="height: 35px;">
                    <h3>&nbsp; TOFILM</h3>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/kisko_t.png" alt="" style="height: 35px;">
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/trescampanas_t.png" alt="" style="height: 35px;">
                    <h3>&nbsp; TRES CAMPANAS</h3>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/electrocontrol_t.png" alt="" style="height: 35px;">
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/escul_t.png" alt="" style="height: 35px;">
                    <h3>&nbsp; ESCUL</h3>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/expertcandela_t.png" alt="" style="height: 35px;">
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/godzillamarketing_t.png" alt="" style="height: 35px;">
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/taboudesign_t.png" alt="" style="height: 35px;">
                    <h3>&nbsp; TABOU DESIGN</h3>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/trazaterritoria_t.png" alt="" style="height: 35px;">
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/wsilorca_t.png" alt="" style="height: 35px;">
                    <h3>&nbsp; WSI LORCA</h3>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
                <div class="icon-box" style="margin-bottom: 5px;">
                    <img src="assets/img/customers/guirrete_t.png" alt="" style="height: 35px;">
                    <h3>&nbsp; GUIRRETE</h3>
                </div>
            </div>
          ...
          <div class="portfolio-wrap">
            ...
            <div class="portfolio-info">
              ...
              <div class="portfolio-links">
                <a href="assets/img/portfolio/portfolio-1.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Mas Proyectos"><i class="bx bx-plus"></i></a>
    ...
    <div class="container">
      ...
      <form action="forms/contact.php" method="post" role="form" class="php-email-form mt-4">
        ...
        <div class="my-3">
          ...
          <div class="sent-message">Tu mensaje ha sido mandado. Gracias!</div>
        </div>
