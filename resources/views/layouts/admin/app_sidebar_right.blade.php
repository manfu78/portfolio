<div class="sidebar sidebar-right sidebar-animate">
    <div class="panel panel-primary card mb-0 shadow-none border-0">
        <div class="tab-menu-heading border-0 d-flex p-3">
            <div class="card-title mb-0"><i class="fe fe-bell me-2"></i>{{ trans('messages.Notification.Notifications') }}</div>
        ...
        <div class="panel-body tabs-menu-body latest-tasks p-0 border-0">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="notifications_slide">
                            ...
                            <li class="d-sm-flex mt-4">
                                @if ($myNotification->readed)
                                    <div>
                                        ...
                                        <h6 class="fw-semibold">{{ date('d/m/Y',strtotime($myNotification->date)) }}<span class="text-muted fs-11 mx-2 fw-normal">{{ date('h:i',strtotime($myNotification->date)) }}</span></h6>
                                        <p class=" fs-12">
                                            {{ $myNotification->name }}
                                        </p>
                                    </div>
                                    <div class="ms-auto d-md-flex me-3">
                                        <a href="javascript:void(0)" class="text-muted">
                                            <span data-bs-effect="effect-flip-horizontal" data-bs-toggle="modal" href="#modal_notify_readed"
                                                data-title="{{ $myNotification->name }}"
                                                data-text="{{ $myNotification->descriptions }}"
                                                data-date="{{ date('d/m/Y',strtotime($myNotification->date)).' '.date('h:i',strtotime($myNotification->date)) }}"
                                                data-route="{{ $myNotification->route }}"
                                                >
                                                <span class="fa-solid fa-envelope-open"></span>
                                            </span>
                                        </a>
                                    </div>
                                @else
                                    <div>
                                        <i class="task-icon1 bg-danger"></i>
                                        <h6 class="fw-bold text-danger">{{ date('d/m/Y',strtotime($myNotification->date)) }}<span class="text-muted fs-11 mx-2 fw-normal">{{ date('h:i',strtotime($myNotification->date)) }}</span></h6>
                                        <p class=" fs-12">
                                            {{ $myNotification->name }}
                                            @if ($myNotification->route)
                                                <a href="{{ $myNotification->route }}" class="fw-semibold" target="_blank">&nbsp;<span class="fa-solid fa-link"></span></a>
                                            @endif

                                        </p>
                                    </div>
                                    <div class="ms-auto d-md-flex me-3">
                                        {{-- <a href="javascript:void(0)" class="text-muted me-2"><span class="fe fe-eye"></span></a> --}}
                                        <a href="javascript:void(0)" class="text-danger">
                                            <span data-bs-effect="effect-flip-horizontal" data-bs-toggle="modal" href="#modal_notify"
                                                data-title="{{ $myNotification->name }}"
                                                data-text="{{ $myNotification->description }}"
                                                data-date="{{ date('d/m/Y',strtotime($myNotification->date)).' '.date('h:i',strtotime($myNotification->date)) }}"
                                                data-route="{{ $myNotification->route }}"
                                                data-action="{{ route('admin.notifications.markAsRead',$myNotification->id) }}">
                    ...
                    <ul>
                        <li class="mt-2">
                            <div class="text-center">
                                <small><a href="#">{{ trans('messages.ViewAll') }}...</a></small>
                            </div>
                        </li>
                    </ul>
                </div>
...
@include('layouts.admin.modal.notification-html')
@include('layouts.admin.modal.notification-readed-html')
